...
def SSIM(x:np.array, y:np.array, c1:float=sqrt(1 / 255), c2:float=sqrt(1 / 255)) -> float:
    LENGTH = 255
...
def DSSIM(x:np.array, y:np.array, c1:float=sqrt(1 / 255), c2:float=sqrt(1 / 255)) -> float:
